...
`go install github.com/renso-ai/code-graph-go/cmd/code_graph@v1.0.4`
...
repo only hosts the Go launcher that downloads the licensed
binaries; it ships no Code Graph source.
